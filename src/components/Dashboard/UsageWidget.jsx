...
const UsageWidget = () => {
  ...
  useEffect(() => {
    const fetchBillingData = async () => {
      try {
        ...
        // Non impostare l'errore per mostrare comunque i dati simulati dal backend
      } finally {
        setLoading(false);
      }
    };
  ...
  // In questo caso, non mostriamo più il messaggio di errore
  // perché il backend gestisce l'errore e restituisce dati simulati
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={6}>
          ...
          <Box sx={{ mb: 3 }}>
            ...
            <Typography variant="body2" color="text.secondary">
              Costo netto: {billingData?.netCost.toFixed(2)} €
            </Typography>
          </Box>
        </Grid>
        ...
        <Grid item xs={12}>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
            <Typography variant="caption" color="text.secondary">
              Progetto: {billingData?.projectId}
            </Typography>
            <Typography variant="caption" color="text.secondary">
              Account di fatturazione: {billingData?.billingAccountId}
            </Typography>
          </Box>
        </Grid>
      </Grid>
